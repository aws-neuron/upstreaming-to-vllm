...
class KVTransferAgent:
    ...
    def send_kv_caches_and_hidden_states(
        ...
        # Note: KVTransferAgent is already removed in newer vLLM version
        raise NotImplementedError("Use API under NeuronConnector directly")
    ...
    def set_output_token(self, model_input, hidden_states):
        return self.connector.set_output_token(model_input, hidden_states)
